...
static void fix_options (void)
{
...
#endif
    if (currprefs.cpu_model < 68020 && currprefs.z3fastmem_size > 0) {
    ...
    if (currprefs.gfxmem_size > 0 && (currprefs.cpu_model < 68020 || currprefs.address_space_24)) {
...
//	currprefs.dfxclick[0] = -1;
//	currprefs.dfxclickvolume = 0;
